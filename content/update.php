...
<form action="aksi/aksi_update.php" method="POST">
    ...
    <div class="content">
        <table class="table-form" border="0" width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td width="20%"><label for="nama_lengkap">Nama Lengkap</label></td>
                    <td colspan="3"><input name="nama_lengkap" id="nama_lengkap" type="text" class="form" value="<?php echo $data['nama_lengkap']; ?>"></td>
            </tr>
            <tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><input name="no_hp" id="no_hp" type="number" class="form" value="<?php echo $data['no_hp']; ?>"></td>
                </tr>
                <tr>
