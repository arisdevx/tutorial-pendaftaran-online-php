        ...
        <?php 
            ...
            while($data = mysqli_fetch_array($anggota)) { ?>
                <tr>
                    ...
                    <td align="center">
                        <a href="index.php?page=detail&id=<?php echo $data['ID']; ?>">Lihat</a> | <a href="index.php?page=update&id=<?php echo $data['ID']; ?>">Edit</a> | <a href="index.php?page=hapus&id=<?php echo $data['ID']; ?>">Hapus</a>
                    </td>
                </tr>
            <?php 
                $no++;
